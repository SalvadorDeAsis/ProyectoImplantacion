...
namespace Reportes.GUI
{
    public partial class visorMedicamentos : Form
    {
        ...
        private void btnMostrar_Click(object sender, EventArgs e)
        {
            try
            {
                reporte = new REP.Medicamento(); // Corrige el nombre de la clase del informe si es diferente
                reporte.SetDataSource(DataLayer.Consulta.MedicamentosSegunPeriodo(dtpInicio.Text, dtpFinal.Text));
